...
PICS = (environ.get('PICS', 'https://files.catbox.moe/9i2mvp.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1430259940 8264647571').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003771712401 -1003604883661').split()]  # Channel id for auto indexing (make sure bot is admin)
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '1430259940')    # Owner UPI ID for payments
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003546017930')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003546017930')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/download_tutorial_video")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/download_tutorial_video")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/download_tutorial_video")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "fsafeg") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "xcfxfbfcgg.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "sdfsdfsd")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "dgdxdsdds.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "dfgsdgdSv")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "dfsdffdsfds.com") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/cinenmahub') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/im_king_in_my_own_world') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/cinenmahub') # Update channel link for the bot
